module.exports = {
  ...
  browser: [
    ...
    { width: 1400, height: 1200, name: "firefox-one-version-back" },
    { width: 1600, height: 1200, name: "edgechromium-one-version-back" },
    { width: 1200, height: 1200, name: "safari-one-version-back" },
    { width: 1024, height: 768, name: "chrome-two-versions-back" },
    { width: 1400, height: 1200, name: "firefox-two-versions-back" },
    { width: 1600, height: 1200, name: "edgechromium-two-versions-back" },
    { width: 1200, height: 1200, name: "safari-two-versions-back" },
    { width: 1024, height: 768, name: "chrome" },
    { width: 1400, height: 1200, name: "firefox" },
    { width: 1600, height: 1200, name: "edgechromium" },
    { width: 1200, height: 1200, name: "safari" },
